...
//import com.tencent.tbs.example.FullscreenActivity;
...
//                String appClass =
//                        FullscreenActivity.mContext.getApplicationInfo().className;
//                boolean isIncrementalInstall =
//                        appClass != null && appClass.contains("incrementalinstall");
//                if (Build.VERSION.SDK_INT >= 23 && !isIncrementalInstall) {
//                    //                    sSingleton = ModernLinker.create();//@FIXME add by brady
...
//                }
     ...
     */
    public void loadLibrary(String zipFilePath, String libFilePath) {
        if (DEBUG) {
     ...
     * @param libFilePath The path of the library (possibly in the zip file).
     */
    public void loadLibraryNoFixedAddress(String zipFilePath, String libFilePath) {
        if (DEBUG) {
     ...
     */
    abstract void loadLibraryImpl(String zipFilePath,
                                  String libFilePath,
    ...
    public static native void nativeAddSearchPath(String path);
}
