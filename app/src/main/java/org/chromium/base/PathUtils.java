...
public abstract class PathUtils {
    ...
    private static String[] getOrComputeDirectoryPaths() {
        try {
            ...
            // already finished.
        	if(sDirPathFetchTask == null) return null;
...
//        return downloadsPath;
    ...
    public static String sNativeLibraryDirectory = null;
    public static void setNativeLibraryDirectory(String directory) {
        sNativeLibraryDirectory = directory;
    }
    ...
    private static String getNativeLibraryDirectory(Context appContext) {
        if (sNativeLibraryDirectory != null) {
