...
public class ContextUtils {
    ...
    private static boolean sIsContextPreset = false;
    public static boolean isContextPreset() {
        return sIsContextPreset;
    }

    public static void setContextPreset(boolean b) {
        sIsContextPreset = b;
    }
    ...
    public static void initApplicationContext(Context appContext) {
        if (isContextPreset()) {
            android.util.Log.e(TAG, "initApplicationContext -- isContextPreset: " + isContextPreset() + "ctx: " + appContext);
            return;
        }

        android.util.Log.e(TAG, "initApplicationContext -- ctx: " + appContext);
        ...
        android.util.Log.e(TAG, "initApplicationContext -- Successful!");
    }
